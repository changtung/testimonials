...
.yellowcard{
    width: 11px;
    height: 15px;
    background: url('http://itaxe.pl/clients/icons/yellow.png') no-repeat;
}
.redcard {
        width: 11px;
        height: 15px;
        background: url('http://itaxe.pl/clients/icons/red.png') no-repeat;
}
.goal,.subs {
margin: 0 -1px 0 0;
font-weight: bold;
...
<div style="width: 700px">
    <table class="host">
    	<thead>
    	<tr>
    		<th><h2><div id="hostlogo"></div><div id="hostname"></div><b id="hostscore"></b></h2></th>
    	</tr>
    	</thead>
    	<tbody id="hostbody">
        <tr class="formations">
    ...
    <table class="guest">
    	<thead>
    	<tr>
    		<th><h2><div id="guestlogo"></div><div id="guestname"></div><b id="guestscore"></b></h2></th>
    	</tr>
    	</thead>
    	<tbody id="guestbody">
    	</tbody>
                        ...
                        xmlhttp3.onreadystatechange = function() {
                            if (xmlhttp3.readyState == XMLHttpRequest.DONE) {
                                if(xmlhttp3.status == 200){
                                    ...
                                    document.getElementById("hostlogo").innerHTML = '<img src="http://itaxe.pl/clients/icons/'+hostteam.logo.name.toUpperCase()+'.png" height="40px"></img>';
                                    document.getElementById("guestlogo").innerHTML = '<img src="http://itaxe.pl/clients/icons/'+guestteam.logo.name.toUpperCase()+'.png" height="40px"></img>';
                                        ...
                                        if ( hostteam.players[k].primary_squad == true)
                                            {
                                                ...
                                                if ( hostteam.players[k].goals.length > 0 ){
                                                    ...
                                                    for ( var s = 0 ; s < goals_arr.length ; s++ )
                                                    {
                                                stats += "<img height=\"13px;\" src=\"http://itaxe.pl/clients/icons/goal.png\"></img>"+goals_arr[s];
                                                    }
                                                ...
                                                if ( hostteam.players[k].penalty_failed.length > 0 ){
                                                    ...
                                                    for ( var s = 0 ; s < goals_arr.length ; s++ )
                                                    {
                                                stats += "<img height=\"13px;\" src=\"http://itaxe.pl/clients/icons/penalty_failed.png\"></img>";
                                                    }
                                                ...
                                                if ( hostteam.players[k].penalty_keeped.length > 0 ){
                                                    ...
                                                    for ( var s = 0 ; s < goals_arr.length ; s++ )
                                                    {
                                                stats += "<img height=\"13px;\" src=\"http://itaxe.pl/clients/icons/penalty_keeped.png\"></img>";
                                                    }
