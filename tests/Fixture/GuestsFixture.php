...
class GuestsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'matchteamguest_key' => ['type' => 'index', 'columns' => ['matchteam_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'matchteamguest_key' => ['type' => 'foreign', 'columns' => ['matchteam_id'], 'references' => ['matchteams', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
